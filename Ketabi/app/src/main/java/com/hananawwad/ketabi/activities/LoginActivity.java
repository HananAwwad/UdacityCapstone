...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Get UserModel From Bundle
         */
        userModel = BundleUtil.getUserDataFromBundle(savedInstanceState, getIntent().getExtras(), Constants.USER_DATA_KEY, null);
    ...
    public void signUpClicked(View v){
        ...
        if(validateName() && validateEmail() && validatePassword()){
            ...
            userModel.setEmailId(emailEditText.getText().toString());
            userModel.setUserName(nameEditText.getText().toString());
            LoginFirebaseHelper loginFirebaseHelper = new LoginFirebaseHelper();
            loginFirebaseHelper.createNewUser(userModel, passwordEditText.getText().toString());
    ...
    class LoginEventListener implements LoginFirebaseHelper.LoginEvents{
        ...
        public void onUserCreated(boolean isSuccessfullyCreated, FirebaseError error) {
            if(isSuccessfullyCreated){
                loginFirebaseHelper.firstLogIn(userModel, password);
            } else {
        ...
        public void onFirstTimeUserLogIn(boolean isSuccessfullyLoggedIn, FirebaseError error) {
            if(isSuccessfullyLoggedIn){
                ...
                /** Set global elements **/
                KetabiApplication.getInstance().setUserName(userModel.getUserName());
                KetabiApplication.getInstance().setEmail(userModel.getEmailId());
                KetabiApplication.getInstance().setPassword(password);
                KetabiApplication.getInstance().setPhoneNumber(userModel.getPhoneNumber());

                /** Hide few loading related stuff **/
                dotsTextView.setVisibility(View.GONE);
                loadingTextView.setText(String.format(getString(R.string.welcome), userModel.getUserName()));
