package com.hananawwad.ketabi.alertDialogs;
...
public class AlertMessageDialog {
    ...
    public AlertMessageDialog(Context context, String title, String body, String leftButtonTitle, String rightButtonTitle){
        this(context, title, Html.fromHtml(body), leftButtonTitle, rightButtonTitle);
    }

    public AlertMessageDialog(Context context, String title, Spanned body, String leftButtonTitle, String rightButtonTitle){
